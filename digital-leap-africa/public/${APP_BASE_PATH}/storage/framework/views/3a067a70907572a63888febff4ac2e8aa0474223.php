...
<div class="page-header exams-questions-header">
  <div class="page-header-left">
    <nav aria-label="breadcrumb" class="exams-questions-breadcrumb">
      <?php if($exam->lesson): ?>
        <a href="<?php echo e(route('admin.topics.lessons.index', [$course, $exam->lesson->topic])); ?>" class="breadcrumb-link">Lessons</a>
        <span class="breadcrumb-sep">/</span>
        <span class="breadcrumb-sep"><?php echo e($exam->lesson->topic->title); ?></span>
        <span class="breadcrumb-sep">/</span>
        <span class="breadcrumb-sep"><?php echo e(Str::limit($exam->lesson->title, 30)); ?></span>
        <span class="breadcrumb-sep">/</span>
      <?php else: ?>
        <a href="<?php echo e(route('admin.exams.index', $course)); ?>" class="breadcrumb-link">Tests</a>
        <span class="breadcrumb-sep">/</span>
      <?php endif; ?>
      <span class="breadcrumb-current">Questions</span>
    </nav>
    <h1 class="page-title mb-0">Questions: <?php echo e(Str::limit($exam->title, 50)); ?></h1>
    <p class="page-subtitle text-muted mb-0 mt-1"><?php echo e($exam->lesson ? 'Lesson test – add and manage questions.' : 'Add and manage questions for this test.'); ?></p>
  </div>
  <div class="page-actions">
    <?php if($exam->lesson): ?>
      <a href="<?php echo e(route('admin.topics.lessons.index', [$course, $exam->lesson->topic])); ?>" class="btn-outline">
...
<div class="admin-content">
  ...
  <div class="exam-questions-stats mb-4">
    <div class="stat-pill">
      ...
      <span><?php echo e($exam->questions->count()); ?> question<?php echo e($exam->questions->count() !== 1 ? 's' : ''); ?></span>
    </div>
    <div class="stat-pill">
      <i class="fas fa-star"></i>
      <span><?php echo e($exam->questions->sum('points')); ?> points total</span>
    </div>
  </div>
  ...
  <div class="card exam-questions-card">
    <div class="card-body">
      <?php $__empty_1 = true; $__currentLoopData = $exam->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <article class="question-block" data-question-id="<?php echo e($q->id); ?>">
          <div class="question-block-header">
            <div class="question-meta">
              <span class="question-num">#<?php echo e($index + 1); ?></span>
              <span class="question-type-badge"><?php echo e(ucfirst(str_replace('_', ' ', $q->question_type))); ?></span>
              <span class="question-points-badge"><?php echo e($q->points); ?> pts</span>
            </div>
            <div class="question-actions">
              <button type="button" class="btn btn-sm btn-outline edit-question-btn" data-question="<?php echo e(json_encode([
                'id' => $q->id,
              ...
              <form method="POST" action="<?php echo e(route('admin.exams.questions.destroy', [$course, $exam, $q])); ?>" class="d-inline" onsubmit="return confirm('Delete this question?');">
                <?php echo csrf_field(); ?>
          ...
          <p class="question-text"><?php echo e($q->question_text); ?></p>
          <?php if($q->options->count()): ?>
            <ul class="question-options-list">
              <?php $__currentLoopData = $q->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="question-option <?php echo e($opt->is_correct ? 'is-correct' : ''); ?>">
...
<div class="exam-popup-overlay" id="addQuestionModal" role="dialog" aria-labelledby="addQuestionModalLabel" aria-modal="true" hidden>
  ...
  <div class="exam-popup-dialog">
    <div class="exam-modal-content">
      ...
      <form method="POST" action="<?php echo e(route('admin.exams.questions.store', [$course, $exam])); ?>">
        <?php echo csrf_field(); ?>
...
<div class="exam-popup-overlay" id="editQuestionModal" role="dialog" aria-labelledby="editQuestionModalLabel" aria-modal="true" hidden>
  ...
  <div class="exam-popup-dialog">
    <div class="exam-modal-content">
      ...
      <form id="edit-question-form" method="POST" action="" data-action-base="<?php echo e(route('admin.exams.questions.update', [$course, $exam, 0])); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digital-leap-africa\digital-leap-africa\resources\views/admin/exams/questions.blade.php ENDPATH**/ ?>