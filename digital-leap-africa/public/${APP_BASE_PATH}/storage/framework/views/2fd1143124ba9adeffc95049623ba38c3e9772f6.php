...
<div class="container">
    ...
    <div class="course-hero">
        ...
        <div style="padding: 2rem;">
            ...
            <?php if($course->has_certification && isset($userCertificate) && $userCertificate): ?>
                <div style="margin-top: 2rem; padding: 1.25rem; background: rgba(251, 191, 36, 0.12); border: 1px solid rgba(251, 191, 36, 0.3); border-radius: 12px;">
                    ...
                    <div style="display: flex; flex-wrap: wrap; gap: 0.75rem;">
                        <a href="<?php echo e(route('certificates.show', $userCertificate)); ?>" class="btn-primary" style="padding: 0.6rem 1.25rem; font-size: 0.95rem; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem;">
    ...
    <?php if(auth()->guard()->check()): ?>
        ...
        ?>
        <?php if($userCourse): ?>
            <?php if($userCourse->pivot->status === 'pending_pre_test'): ?>
                <?php
                ...
                <div class="enrollment-section">
                    ...
                    <?php if($preCourseTestPending): ?>
                        <a href="<?php echo e(route('exams.show', $preCourseTestPending)); ?>" class="btn-primary" style="padding: 0.75rem 2rem; font-size: 1.1rem; display: inline-block; text-decoration: none;">
                            <i class="fas fa-play me-2"></i>Take Pre-Course Test
                        </a>
                    <?php endif; ?>
                </div>
            <?php elseif($userCourse->pivot->status === 'active'): ?>
                <div class="enrollment-section">
                ...
                <?php if($preCourseExam && !$preCourseAttempt): ?>
                    <div class="enrollment-section" style="margin-top: 1rem;">
                        ...
                        <a href="<?php echo e(route('exams.show', $preCourseExam)); ?>" class="btn-primary" style="padding: 0.75rem 1.5rem;">
                            <i class="fas fa-play me-2"></i>Take Pre-Course Test
                        </a>
                    </div>
                <?php endif; ?>

                <?php if($finalExam && $allCourseworkDone && !$finalAttempt): ?>
                    <div class="enrollment-section" style="margin-top: 1rem;">
                        ...
                        <a href="<?php echo e(route('exams.show', $finalExam)); ?>" class="btn-primary" style="padding: 0.75rem 1.5rem;">
                            <i class="fas fa-play me-2"></i>Take Final Test
                        </a>
                    </div>
                <?php endif; ?>
            <?php elseif($userCourse->pivot->status === 'pending'): ?>
                <div class="enrollment-section">
            ...
            <?php elseif($userCourse->pivot->status === 'rejected'): ?>
                <div class="enrollment-section">
        ...
        <?php else: ?>
            ...
            <?php else: ?>
                <div class="enrollment-section">
                    ...
                    <a href="<?php echo e(route('courses.enroll-form', $course)); ?>" class="btn-primary" style="padding: 0.75rem 2rem; font-size: 1.1rem; display: inline-block; text-decoration: none;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digital-leap-africa\digital-leap-africa\resources\views/pages/courses/show.blade.php ENDPATH**/ ?>