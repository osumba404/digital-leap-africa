...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title><?php echo $__env->yieldContent('title', $siteSettings['meta_title'] ?? 'Digital Leap Africa - Premier Tech Education Platform in Africa | Programming Courses & Career Development'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', $siteSettings['meta_description'] ?? 'Empowering African youth through comprehensive e-learning courses, job opportunities, and vibrant community. Join Digital Leap Africa for tech skills, career development, and professional growth.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', $siteSettings['keywords'] ?? 'programming courses Africa, web development Kenya, tech education Nigeria, coding bootcamp Ghana, software development training, digital skills Africa, tech careers Kenya, programming jobs Nigeria, web developer course, full stack development Africa'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', $siteSettings['meta_title'] ?? 'Digital Leap Africa - Premier Tech Education Platform in Africa'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', $siteSettings['meta_description'] ?? 'Transform your tech career with expert-led programming courses, web development training, and career opportunities across Africa.'); ?>">
    <meta property="og:url" content="<?php echo $__env->yieldContent('og_url', url()->current()); ?>">
    <meta property="og:image" content="<?php echo $__env->yieldContent('og_image', $siteSettings['opengraph_image'] ?? asset('images/og-default.jpg')); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('twitter_title', $siteSettings['meta_title'] ?? 'Digital Leap Africa - Premier Tech Education Platform in Africa'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('twitter_description', $siteSettings['meta_description'] ?? 'Transform your tech career with expert-led programming courses and career opportunities across Africa.'); ?>">
    <meta name="twitter:image" content="<?php echo $__env->yieldContent('twitter_image', $siteSettings['opengraph_image'] ?? asset('images/twitter-card.jpg')); ?>">
    
    <!-- Favicon -->
    <?php if(!empty($siteSettings['favicon'])): ?>
    <link rel="icon" type="image/x-icon" href="<?php echo e($siteSettings['favicon']); ?>">
    <?php endif; ?>
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "<?php echo e(url('/')); ?>",
        "logo": "<?php echo e($siteSettings['logo_url'] ?? asset('images/logo.png')); ?>",
        ...
        "contactPoint": {
            "@type": "ContactPoint",
            "email": "<?php echo e($siteSettings['contact_email'] ?? 'info@digitalleap.africa'); ?>",
            "contactType": "customer service"
        },
        "sameAs": [
            <?php if(!empty($siteSettings['facebook_url'])): ?>"<?php echo e($siteSettings['facebook_url']); ?>",<?php endif; ?>
            <?php if(!empty($siteSettings['twitter_url'])): ?>"<?php echo e($siteSettings['twitter_url']); ?>",<?php endif; ?>
            <?php if(!empty($siteSettings['linkedin_url'])): ?>"<?php echo e($siteSettings['linkedin_url']); ?>",<?php endif; ?>
            <?php if(!empty($siteSettings['youtube_url'])): ?>"<?php echo e($siteSettings['youtube_url']); ?>",<?php endif; ?>
            <?php if(!empty($siteSettings['instagram_url'])): ?>"<?php echo e($siteSettings['instagram_url']); ?>"<?php endif; ?>
        ]
    }
    </script>
    ...
    <?php if(!empty($siteSettings['google_analytics_id'])): ?>
    <!-- Google Analytics 4 -->
    ...
    <style>
        ...
        :root {
            ...
            --cool-gray: 	#AEB8C2;
            --charcoal: 	#252A32;
            --cyan-accent: <?php echo e($siteSettings['secondary_color'] ?? '#00C9FF'); ?>;
        ...
        [data-theme="light"] {
            ...
            --cool-gray: 	#4A5568;
            --charcoal: 	#FFFFFF;
            --cyan-accent: <?php echo e($siteSettings['secondary_color'] ?? '#0088CC'); ?>;
        ...
        * { box-sizing: border-box; }
        ...
        body {
            margin: 0;
            font-family: "<?php echo e($siteSettings['font_family'] ?? 'Inter'); ?>", system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial;
...
<body>
    <header class="site-header">
        <nav class="nav">
            ...
            <img
                src="<?php echo e(url($siteSettings['logo_url'])); ?>"
                alt="<?php echo e($siteSettings['site_name'] ?? 'Site Logo'); ?>"
                class="site-logo"
            ...
            <?php endif; ?>
                <div>
                    <h1><?php echo e($siteSettings['site_name'] ?? config('app.name')); ?></h1>
                    <span class="tagline"><?php echo e($siteSettings['tagline'] ?? 'Digital Leap Africa'); ?></span>
                </div>
            </a>
            ...
            <div class="nav-main-group"> 
                <ul class="nav-links">
                    <li><a href="<?php echo e(route('home')); ?>" class="<?php if(request()->routeIs('home')): ?> active <?php endif; ?>">Home</a></li>
                    <li><a href="<?php echo e(route('about')); ?>" class="<?php if(request()->routeIs('about')): ?> active <?php endif; ?>">About</a></li>
                    <li><a href="<?php echo e(route('courses.index')); ?>" class="<?php if(request()->routeIs('courses.*')): ?> active <?php endif; ?>">Courses</a></li>
                    <li><a href="<?php echo e(route('blog.index')); ?>" class="<?php if(request()->routeIs('blog.*')): ?> active <?php endif; ?>">Blog</a></li>
                    ...
                    <li class="dropdown" onmouseenter="clearTimeout(this.hideTimer); this.querySelector('.dropdown-menu').style.display='block'" onmouseleave="this.hideTimer = setTimeout(() => this.querySelector('.dropdown-menu').style.display='none', 300)">
                        <a href="#" class="<?php if(request()->routeIs('elibrary.*') || request()->routeIs('events.*') || request()->routeIs('jobs.*') || request()->routeIs('forum.*')): ?> active <?php endif; ?>" style="display:flex;align-items:center;gap:.35rem;">
                        ...
                        <ul class="dropdown-menu" style="display:none;position:absolute;margin-top:.5rem;background:linear-gradient(135deg, var(--charcoal) 0%, var(--navy-bg) 100%);border:1px solid rgba(0,201,255,.2);border-radius:8px;min-width:220px;box-shadow:0 10px 20px rgba(0,0,0,.5);padding:.4rem 0;z-index:1002;">
                            <li><a href="<?php echo e(route('elibrary.index')); ?>" class="<?php if(request()->routeIs('elibrary.*')): ?> active <?php endif; ?>" style="display:block;padding:.5rem 1rem;">eLibrary</a></li>
                            <li><a href="<?php echo e(route('events.index')); ?>" class="<?php if(request()->routeIs('events.*')): ?> active <?php endif; ?>" style="display:block;padding:.5rem 1rem;">Events</a></li>
                            <li><a href="<?php echo e(route('forum.index')); ?>" class="<?php if(request()->routeIs('forum.*')): ?> active <?php endif; ?>" style="display:block;padding:.5rem 1rem;">Forum</a></li>
                        </ul>
                    </li>
                    ...
                    <!-- <li class="dropdown" onmouseenter="this.querySelector('.dropdown-menu').style.display='block'" onmouseleave="this.querySelector('.dropdown-menu').style.display='none'">
                        <a href="#" class="<?php if(request()->routeIs('blog.*') || request()->routeIs('contact') || request()->routeIs('donate')): ?> active <?php endif; ?>" style="display:flex;align-items:center;gap:.35rem;">
                        ...
                        <ul class="dropdown-menu" style="display:none;position:absolute;margin-top:.5rem;background:#0d47a1;border:1px solid rgba(255,255,255,.15);border-radius:8px;min-width:200px;box-shadow:0 10px 20px rgba(0,0,0,.35);padding:.4rem 0;z-index:1002;">
                            <li><a href="<?php echo e(route('projects.index')); ?>" class="<?php if(request()->routeIs('projects.*')): ?> active <?php endif; ?>" style="display:block;padding:.5rem 1rem;">Projects</a></li>
                            <li><a href="<?php echo e(route('jobs.index')); ?>" class="<?php if(request()->routeIs('jobs.*')): ?> active <?php endif; ?>" style="display:block;padding:.5rem 1rem;">Jobs</a></li>
                            <li><a href="<?php echo e(route('forum.index')); ?>" class="<?php if(request()->routeIs('forum.*')): ?> active <?php endif; ?>" style="display:block;padding:.5rem 1rem;">Forum</a></li>
                            <li><a href="<?php echo e(route('contact')); ?>" class="<?php if(request()->routeIs('contact')): ?> active <?php endif; ?>" style="display:block;padding:.5rem 1rem;">Contact</a></li>
                            <li><a href="<?php echo e(route('donate')); ?>" class="<?php if(request()->routeIs('donate')): ?> active <?php endif; ?>" style="display:block;padding:.5rem 1rem;">Donate</a></li>
                ...
                <div class="nav-actions-group">
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->role === 'admin'): ?>
                            ...
                            <div class="dropdown" style="position:relative;display:inline-block;" 
                                ...
                                <ul class="dropdown-menu" style="display:none;position:absolute;margin-top:.5rem;background:linear-gradient(135deg, var(--charcoal) 0%, var(--navy-bg) 100%);border:1px solid rgba(0,201,255,.2);border-radius:8px;min-width:200px;box-shadow:0 10px 20px rgba(0,0,0,.5);padding:.4rem 0;z-index:1002;right:0;">
                                    <li>
                                        <a href="<?php echo e(route('dashboard')); ?>" style="display:block;padding:.5rem 1rem;color:#dbe1ea;text-decoration:none;">
                                            <i class="fas fa-gauge me-2"></i>User Dashboard
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.dashboard')); ?>" style="display:block;padding:.5rem 1rem;color:#dbe1ea;text-decoration:none;">
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn-outline btn-sm">
                        ...
                        <div class="dropdown" style="position:relative;display:inline-block;" 
                            ...
                            <a href="#" class="user-profile-btn" style="display:flex;align-items:center;gap:.5rem;">
                                <div class="user-avatar-container">
                                    <span class="user-avatar-initial"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                            ...
                            <ul class="dropdown-menu" style="display:none;position:absolute;margin-top:.5rem;background:linear-gradient(135deg, var(--charcoal) 0%, var(--navy-bg) 100%);border:1px solid rgba(0,201,255,.2);border-radius:8px;min-width:200px;box-shadow:0 10px 20px rgba(0,0,0,.5);padding:.4rem 0;z-index:1002;right:0;">
                                <li>
                                    <a href="<?php echo e(route('profile.edit')); ?>" style="display:block;padding:.5rem 1rem;color:#dbe1ea;text-decoration:none;">
        ...
        <div class="sidebar-content" style="padding-top: 1rem;">
            <ul class="nav-links">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>" class="user-profile-btn">
                        <div class="user-avatar-container">
                            <span class="user-avatar-initial"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                            <?php if(Auth::user()->email_verified_at): ?>
                                <span class="verification-badge">
        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-section">
                    ...
                    <div class="social-links">
                        <?php if(!empty($siteSettings['twitter_url'])): ?>
                            <a href="<?php echo e($siteSettings['twitter_url']); ?>" class="social-link" title="Twitter/X" target="_blank" rel="noopener"><i class="fa-brands fa-x-twitter"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($siteSettings['linkedin_url'])): ?>
                            <a href="<?php echo e($siteSettings['linkedin_url']); ?>" class="social-link" title="LinkedIn" target="_blank" rel="noopener"><i class="fa-brands fa-linkedin-in"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($siteSettings['facebook_url'])): ?>
                            <a href="<?php echo e($siteSettings['facebook_url']); ?>" class="social-link" title="Facebook" target="_blank" rel="noopener"><i class="fa-brands fa-facebook-f"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($siteSettings['instagram_url'])): ?>
                            <a href="<?php echo e($siteSettings['instagram_url']); ?>" class="social-link" title="Instagram" target="_blank" rel="noopener"><i class="fa-brands fa-instagram"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($siteSettings['youtube_url'])): ?>
                            <a href="<?php echo e($siteSettings['youtube_url']); ?>" class="social-link" title="YouTube" target="_blank" rel="noopener"><i class="fa-brands fa-youtube"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($siteSettings['tiktok_url'])): ?>
                            <a href="<?php echo e($siteSettings['tiktok_url']); ?>" class="social-link" title="TikTok" target="_blank" rel="noopener"><i class="fa-brands fa-tiktok"></i></a>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <?php if(Route::has('courses.index')): ?>
                            <li><a href="<?php echo e(route('courses.index')); ?>"><i class="fas fa-graduation-cap"></i> Courses</a></li>
                        <?php endif; ?>
                        <?php if(Route::has('articles.index')): ?>
                            <li><a href="<?php echo e(route('articles.index')); ?>"><i class="fas fa-newspaper"></i> Articles</a></li>
                        <?php endif; ?>
                        <?php if(Route::has('forum.index')): ?>
                            <li><a href="<?php echo e(route('forum.index')); ?>"><i class="fas fa-comments"></i> Forum</a></li>
                        <?php endif; ?>
                        <li><a href="<?php echo e(route('testimonials.index')); ?>"><i class="fas fa-quote-left"></i> Testimonials</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        <li><a href="<?php echo e(route('about')); ?>"><i class="fas fa-info-circle"></i> About Us</a></li>
                        ...
                        <li><a href="<?php echo e(route('terms.service')); ?>"><i class="fas fa-file-contract"></i> Terms of Service</a></li>
                        <?php if(!empty($siteSettings['contact_email'])): ?>
                            <li><a href="mailto:<?php echo e($siteSettings['contact_email']); ?>"><i class="fas fa-envelope"></i> <?php echo e($siteSettings['contact_email']); ?></a></li>
                        <?php endif; ?>
                        <?php if(!empty($siteSettings['contact_phone'])): ?>
                            <li><a href="tel:<?php echo e($siteSettings['contact_phone']); ?>"><i class="fas fa-phone"></i> <?php echo e($siteSettings['contact_phone']); ?></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
            ...
            <div class="footer-bottom">
                <div class="footer-text">
                    <?php echo $siteSettings['footer_text'] ?? ('&copy; ' . date('Y') . ' ' . ($siteSettings['site_name'] ?? config('app.name')) . '. All rights reserved.'); ?>
...
</html><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views/layouts/app.blade.php ENDPATH**/ ?>