...
<div class="admin-content">
  <div class="quick-actions" style="display:grid;grid-template-columns:repeat(4,1fr);gap:1rem;">
    ...
    <a class="btn btn-edit" href="<?php echo e(route('admin.exams.index', $course)); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digital-leap-africa\digital-leap-africa\resources\views/admin/courses/manage.blade.php ENDPATH**/ ?>