...
<meta property="og:image" content="<?php if(!empty($heroSlides) && !empty($heroSlides[0]['image'])): ?><?php echo e(url($heroSlides[0]['image'])); ?><?php else: ?><?php echo e(asset('images/og-image.jpg')); ?><?php endif; ?>">
...
<meta name="twitter:image" content="<?php if(!empty($heroSlides) && !empty($heroSlides[0]['image'])): ?><?php echo e(url($heroSlides[0]['image'])); ?><?php else: ?><?php echo e(asset('images/og-image.jpg')); ?><?php endif; ?>">
          ...
          <div class="hero-caption">
            <div class="slide-content">
              ...
              <?php if(!empty($slide['sub'])): ?>
                <p class="hero-text hero-sub" style="font-size: 1.3rem; margin-bottom: 2rem; max-width: 600px; color: #f1f3f5; margin-left: auto; margin-right: auto; text-align: center;"><?php echo e($slide['sub']); ?></p>
              <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digital-leap-africa\digital-leap-africa\resources\views/index.blade.php ENDPATH**/ ?>