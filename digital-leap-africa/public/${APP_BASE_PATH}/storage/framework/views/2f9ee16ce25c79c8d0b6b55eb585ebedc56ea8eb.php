        ...
        <div class="certificate-inner">
            <div class="certificate-header">
                <div class="certificate-logo-wrap">
                    <?php if(isset($siteSettings['logo_url']) && !empty($siteSettings['logo_url'])): ?>
                        <img src="<?php echo e(url($siteSettings['logo_url'])); ?>" alt="<?php echo e($siteSettings['site_name'] ?? 'Digital Leap Africa'); ?>">
                    <?php else: ?>
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Digital Leap Africa">
                    <?php endif; ?>
                </div>
            ...
            <div class="certificate-footer">
                ...
                <div class="signature-section">
                    ...
                    <p class="signature-role-name"><?php echo e($directorName); ?></p>
                </div>
            </div>

            <div class="certificate-meta">
                <div class="certificate-date">
                    <i class="fas fa-calendar-alt me-1"></i><?php echo e($certificate->issued_at->format('F j, Y')); ?>

                </div>
                <div class="certificate-number">
                    <i class="fas fa-shield-alt me-1"></i><?php echo e($certificate->certificate_number); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digital-leap-africa\digital-leap-africa\resources\views/certificates/show.blade.php ENDPATH**/ ?>