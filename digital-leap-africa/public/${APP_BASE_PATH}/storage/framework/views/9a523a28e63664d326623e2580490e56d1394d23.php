...
<?php $__env->startSection('title', $exam->title . ' - Test | Digital Leap Africa'); ?>
    ...
    <div class="col-lg-8">
      <div class="lesson-header" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 12px; padding: 2rem; margin-bottom: 2rem;">
        <div class="breadcrumb mb-2">
          <a href="<?php echo e(route('courses.show', $exam->course)); ?>"><?php echo e($exam->course->title); ?></a>
        ...
        <?php if($exam->description): ?>
          <p style="color: var(--cool-gray); margin-bottom: 1rem;"><?php echo e($exam->description); ?></p>
        <?php endif; ?>
        <div style="display: flex; gap: 1rem; flex-wrap: wrap; color: var(--cool-gray); font-size: 0.9rem;">
          <span><i class="fas fa-question-circle me-1"></i><?php echo e($exam->questions->count()); ?> questions</span>
          <span><i class="fas fa-star me-1"></i><?php echo e($totalPoints); ?> points total</span>
          <?php if($exam->time_limit_minutes): ?>
            <span><i class="fas fa-clock me-1"></i><?php echo e($exam->time_limit_minutes); ?> min limit</span>
          <?php endif; ?>
      ...
      <?php if($existingAttempt): ?>
        <div class="lesson-content" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 12px; padding: 2rem; margin-bottom: 2rem;">
          ...
          <p style="color: var(--cool-gray); margin-bottom: 1.5rem;">
            Score: <?php echo e($existingAttempt->total_points_earned); ?>/<?php echo e($existingAttempt->total_points_possible); ?> (<?php echo e($existingAttempt->percentage); ?>%)
          </p>
          <a href="<?php echo e(route('exams.result', $existingAttempt)); ?>" class="btn-primary" style="padding: 0.75rem 1.5rem;">
      ...
      <a href="<?php echo e(route('courses.show', $exam->course)); ?>" class="btn-outline" style="padding: 0.75rem 1.5rem;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digital-leap-africa\digital-leap-africa\resources\views/exams/show.blade.php ENDPATH**/ ?>