<div class="admin-form">
    <div class="form-section">
        ...
        <div class="form-group">
            ...
            <input type="text" id="slug" name="slug" class="form-control" 
                   value="<?php echo e(old('slug', $course->slug ?? '')); ?>" required>
        ...
        <div class="form-group">
            ...
            <textarea id="description" name="description" class="form-control" rows="4" required><?php echo e(old('description', $course->description ?? '')); ?></textarea>
        </div>
            ...
            <div class="form-group">
                ...
                <select id="instructor" name="instructor" class="form-control" required>
                    ...
                    <?php $__currentLoopData = ($instructors ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($instructor->name); ?>" 
                            <?php echo e(old('instructor', $course->instructor ?? '') === $instructor->name ? 'selected' : ''); ?>>
        ...
        <div class="form-group" style="margin-top: 0.5rem;">
            ...
            <div style="display:flex; align-items:center; gap:0.5rem;">
                <input type="checkbox" id="active" name="active" value="1" 
                       <?php echo e(old('active', isset($course) ? (int)($course->active ?? 1) : 1) ? 'checked' : ''); ?>>
        ...
        <div class="form-group" style="margin-top: 0.5rem;">
            ...
            <div style="display:flex; align-items:center; gap:0.5rem;">
                <input type="checkbox" id="is_free" name="is_free" value="1"
                       <?php echo e(old('is_free', isset($course) ? (int)($course->is_free ?? 0) : 0) ? 'checked' : ''); ?>>
                <span style="color: var(--cool-gray);">Toggle if this course is free</span>
            </div>
        </div>

        <div class="form-group" id="price-field" style="margin-top: 1rem; display: <?php echo e(old('is_free', isset($course) ? (int)($course->is_free ?? 0) : 0) ? 'none' : 'block'); ?>;">
            <label for="price" class="form-label">Price (KES)</label>
            <input type="number" id="price" name="price" class="form-control" 
                   value="<?php echo e(old('price', $course->price ?? 0)); ?>" 
        ...
        <div class="form-group" style="margin-top: 1rem;">
            ...
            <select id="course_type" name="course_type" class="form-control" required>
                <option value="self_paced" <?php echo e(old('course_type', $course->course_type ?? 'self_paced') === 'self_paced' ? 'selected' : ''); ?>>Self-Paced</option>
                <option value="cohort_based" <?php echo e(old('course_type', $course->course_type ?? '') === 'cohort_based' ? 'selected' : ''); ?>>Cohort-Based</option>
            </select>
        ...
        <div class="form-group" style="margin-top: 1rem;">
            ...
            <input type="number" id="slots" name="slots" class="form-control" 
                   value="<?php echo e(old('slots', $course->slots ?? '')); ?>" 
        ...
        <div class="form-group" style="margin-top: 1rem;">
            ...
            <div style="display:flex; align-items:center; gap:0.5rem;">
                <input type="checkbox" id="has_certification" name="has_certification" value="1"
                       <?php echo e(old('has_certification', isset($course) ? (int)($course->has_certification ?? 0) : 0) ? 'checked' : ''); ?>>
                <span style="color: var(--cool-gray);">Award certificate upon course completion</span>
            </div>
        </div>

        <div class="form-group" id="certificate-title-field" style="margin-top: 1rem; display: <?php echo e(old('has_certification', isset($course) ? (int)($course->has_certification ?? 0) : 0) ? 'block' : 'none'); ?>;">
            ...
            <input type="text" id="certificate_title" name="certificate_title" class="form-control" 
                   value="<?php echo e(old('certificate_title', $course->certificate_title ?? '')); ?>" 
                   placeholder="e.g., Web Development Fundamentals">
            <small style="color: var(--cool-gray); font-size: 0.85rem;">Title that will appear on the certificate</small>
        </div>

        <div id="cohort-fields" style="display: <?php echo e(old('course_type', $course->course_type ?? 'self_paced') === 'cohort_based' ? 'block' : 'none'); ?>; margin-top: 1rem;">
            <div class="form-group">
                ...
                <input type="number" id="duration_weeks" name="duration_weeks" class="form-control" 
                       value="<?php echo e(old('duration_weeks', $course->duration_weeks ?? '')); ?>" 
    ...
    <div class="form-section">
        ...
        <div class="form-group">
            ...
            <?php if(!empty($course?->image_url_full)): ?>
                <div style="margin-top:0.5rem;">
                    <div class="text-muted small">Current image:</div>
                    <img src="<?php echo e($course->image_url_full); ?>" alt="Course image" style="max-height:140px;border-radius:8px;">
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div style="display: flex; gap: 1rem; justify-content: flex-end; margin-top: 2rem;">
        <a href="<?php echo e(route('admin.courses.index')); ?>" class="btn-outline">Cancel</a>
        <button type="submit" class="btn-primary">
            <i class="fas fa-save me-2"></i><?php echo e(isset($course) ? 'Update Course' : 'Create Course'); ?>
...
</script><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views/admin/courses/_form.blade.php ENDPATH**/ ?>