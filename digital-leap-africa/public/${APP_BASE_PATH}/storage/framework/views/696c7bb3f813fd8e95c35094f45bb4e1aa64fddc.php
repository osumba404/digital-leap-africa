    ...
    <div class="lesson-container">
        ...
        <?php if($lessonExam && Auth::check()): ?>
            <div class="lesson-content" style="margin-bottom: 2rem;">
                ...
                <?php if($lessonExamAttempt): ?>
                    <p style="color: var(--cool-gray); margin-bottom: 1rem;">You've completed this lesson quiz. Score: <?php echo e($lessonExamAttempt->total_points_earned); ?>/<?php echo e($lessonExamAttempt->total_points_possible); ?> (<?php echo e($lessonExamAttempt->percentage); ?>%)</p>
                    <a href="<?php echo e(route('exams.result', $lessonExamAttempt)); ?>" class="btn-outline" style="padding: 0.75rem 1.5rem;">
                        <i class="fas fa-chart-bar me-2"></i>View Results
                    </a>
                <?php else: ?>
                    <p style="color: var(--cool-gray); margin-bottom: 1rem;"><?php echo e($lessonExam->description ?? 'Test your understanding of this lesson.'); ?></p>
                    <a href="<?php echo e(route('exams.show', $lessonExam)); ?>" class="btn-primary" style="padding: 0.75rem 1.5rem;">
        ...
        <div class="completion-section">
            ...
            <?php else: ?>
                ...
                <?php if($lessonExam && !$lessonExamAttempt): ?>
            ...
            <?php if($previousLesson || ($nextLesson && $isFullyCompleted)): ?>
                <div style="margin-top: 2rem; padding-top: 2rem; border-top: 1px solid rgba(255, 255, 255, 0.1); display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                    ...
                    <?php endif; ?>
                    <?php if($nextLesson && $isFullyCompleted): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digital-leap-africa\digital-leap-africa\resources\views/pages/lessons/show.blade.php ENDPATH**/ ?>