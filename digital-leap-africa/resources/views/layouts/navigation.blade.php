<nav x-data="{ open: false }" class="bg-primary-light border-b border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    {{-- This is a public link everyone can see --}}
                    <x-nav-link :href="route('home')" :active="request()->routeIs('home')">
                        {{ __('Home') }}
                    </x-nav-link>

                    {{-- This link will only appear if the user is logged in --}}
                    @auth
            ...
            <!-- This section is for authenticated users (logged in) -->
            @auth
            ...
            @guest
                <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-4">
                    ...
                    <a href="{{ route('register') }}" class="text-sm text-gray-300 hover:text-white underline">Register</a>
                </div>
            @endguest
