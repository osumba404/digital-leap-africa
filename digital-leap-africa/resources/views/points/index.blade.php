...
<div class="points-container">
    ...
    <div class="stats-grid">
        <div class="stat-card points">
            ...
            <div class="stat-value">{{ number_format($userPoints) }}</div>
    ...
    <div class="rewards-grid">
        @foreach($rewards as $key => $reward)
            <div class="reward-card {{ $userPoints >= $reward['cost'] ? 'affordable' : 'expensive' }}">
                <i class="{{ $reward['icon'] ?? 'fas fa-gift' }} reward-icon"></i>
                ...
                <div class="reward-footer">
                    ...
                    @if($userPoints >= $reward['cost'])
                        <form method="POST" action="{{ route('points.redeem') }}" style="margin: 0;">
                            @csrf
