                ...
                @foreach ($threads as $thread)
                    <div class="thread-card">
                        ...
                        @if($thread->latestReply)
                            <div style="padding-top: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.1); color: var(--cool-gray); font-size: 0.9rem;">
                                <i class="fas fa-reply me-1"></i>
                                Latest reply by <span style="color: var(--cyan-accent);">{{ $thread->latestReply->user->name }}</span>
