...
<div class="admin-form">
    <form method="POST" action="{{ route('admin.certificates.update') }}">
        @csrf
        @method('PUT')
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="certificate_title" name="certificate_title" class="form-control" 
                       value="{{ old('certificate_title', $settings['certificate_title']) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="certificate_subtitle" name="certificate_subtitle" class="form-control" 
                       value="{{ old('certificate_subtitle', $settings['certificate_subtitle']) }}" required>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="certificate_text" name="certificate_text" class="form-control" 
                       value="{{ old('certificate_text', $settings['certificate_text']) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="certificate_completion_text" name="certificate_completion_text" class="form-control" 
                       value="{{ old('certificate_completion_text', $settings['certificate_completion_text']) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea id="certificate_achievement_text" name="certificate_achievement_text" class="form-control" rows="3" required>{{ old('certificate_achievement_text', $settings['certificate_achievement_text']) }}</textarea>
        ...
        <div class="form-section">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                <div class="form-group">
                    ...
                    <input type="text" id="certificate_instructor_title" name="certificate_instructor_title" class="form-control" 
                           value="{{ old('certificate_instructor_title', $settings['certificate_instructor_title']) }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="certificate_director_title" name="certificate_director_title" class="form-control" 
                           value="{{ old('certificate_director_title', $settings['certificate_director_title']) }}" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="certificate_director_name" name="certificate_director_name" class="form-control" 
                       value="{{ old('certificate_director_name', $settings['certificate_director_name']) }}" required>
...
<div style="margin-top: 3rem; padding: 1.5rem; background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: var(--radius);">
    ...
    <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
        <a href="{{ route('certificates.show', 1) }}" class="btn-outline" target="_blank">
