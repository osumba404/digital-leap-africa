                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($partner->logo_path)
                                        <img class="h-10 w-auto" src="{{ asset('storage/' . $partner->logo_path) }}" alt="{{ $partner->name }}">
                                    @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <button type="button" onclick="editPartner({{ $partner->id }})" class="text-primary-600 hover:text-primary-900 mr-4">
                                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                        </svg>
                                    </button>
                                    <button type="button" onclick="confirmDelete({{ $partner->id }})" class="text-red-600 hover:text-red-900">
                                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
