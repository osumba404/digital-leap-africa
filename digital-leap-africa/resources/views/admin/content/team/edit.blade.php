...
<div class="card bg-primary-light border-0 shadow-sm rounded">
    ...
    <div class="card-body">
        <form action="{{ route('admin.about.team.update', $teamMember) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="position" class="form-label text-gray-200">Position *</label>
                <input type="text" class="form-control bg-primary-light border-0 text-gray-200" id="position" 
                       name="position" value="{{ old('position', $teamMember->position) }}" required>
            </div>
