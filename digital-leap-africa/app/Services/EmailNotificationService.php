...
class EmailNotificationService
{
    ...
    private static function getSubject($type, $data)
    {
        return match($type) {
            ...
            'course_inactivity_reminder' => 'Course Inactivity Reminder - Digital Leap Africa',
            'course_inactivity_warning' => 'Formal Inactivity Warning - Digital Leap Africa',
            'course_auto_unenrolled' => 'Auto Unenrollment Notice - Digital Leap Africa',
            'new_course' => 'New Course Available - Digital Leap Africa',
            'new_article' => 'New Article Published - Digital Leap Africa',
            'new_event' => 'New Event - Digital Leap Africa',
    ...
    private static function getTemplate($type)
    {
        ...
        return match($type) {
            ...
            'course_inactivity_reminder' => 'emails.course-inactivity-reminder',
            'course_inactivity_warning' => 'emails.course-inactivity-warning',
            'course_auto_unenrolled' => 'emails.course-auto-unenrolled',
            'new_course' => 'emails.new-course',
            'new_article' => 'emails.new-article',
            'new_event' => 'emails.new-event',
    ...
    private static function getContent($type, $user, $data)
    {
        ...
        $body = match($type) {
            ...
            'course_inactivity_reminder' => "We noticed you've been inactive in '{$data['course']->title}' for {$data['days_inactive']} days.\n\nPlease continue your coursework to stay on track.",
            'course_inactivity_warning' => "Formal warning: you have been inactive in '{$data['course']->title}' for {$data['days_inactive']} days.\n\nPlease continue immediately to avoid automatic unenrollment.",
            'course_auto_unenrolled' => "You have been automatically unenrolled from '{$data['course']->title}' after prolonged inactivity.\n\nYou can re-enroll from the courses page.",
            'new_course' => "We're excited to announce a new course: {$data['course']->title}\n\nEnroll now to start learning!",
            'new_article' => "A new article has been published: {$data['article']->title}\n\nRead it on our blog.",
            'new_event' => "New event: {$data['event']->title}\n\nCheck the events page for details.",
