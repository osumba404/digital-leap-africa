...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Digital Leap Africa - Premier Tech Education Platform in Africa | Programming Courses & Career Development'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Transform your tech career with Digital Leap Africa. Expert-led programming courses, web development training, and career opportunities across Kenya, Nigeria, Ghana, and all of Africa. Join 10,000+ successful graduates.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'programming courses Africa, web development Kenya, tech education Nigeria, coding bootcamp Ghana, software development training, digital skills Africa, tech careers Kenya, programming jobs Nigeria, web developer course, full stack development Africa'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', 'Digital Leap Africa - Premier Tech Education Platform in Africa'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', 'Transform your tech career with expert-led programming courses, web development training, and career opportunities across Africa. Join 10,000+ successful graduates.'); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('twitter_title', 'Digital Leap Africa - Premier Tech Education Platform in Africa'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('twitter_description', 'Transform your tech career with expert-led programming courses and career opportunities across Africa.'); ?>">
...
</head><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\layouts\seo-head.blade.php ENDPATH**/ ?>