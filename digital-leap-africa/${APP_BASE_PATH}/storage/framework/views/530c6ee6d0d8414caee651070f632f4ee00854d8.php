...
<div class="message">
    Thank you for your interest in <strong><?php echo e($course->title); ?></strong>. After reviewing your enrollment request, we need to discuss your application further.
</div>
...
<a href="<?php echo e(url('/contact')); ?>" class="cta-button">
...
<?php echo $__env->make('emails.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\emails\course-rejected.blade.php ENDPATH**/ ?>