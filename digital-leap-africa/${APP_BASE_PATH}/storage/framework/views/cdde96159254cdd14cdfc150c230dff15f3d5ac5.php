...
<div class="space-y-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow">
        ...
        <form action="<?php echo e(route('admin.content.team.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="px-4 py-4 sm:px-6">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <?php if($member->image_path): ?>
                                            <img class="h-10 w-10 rounded-full" src="<?php echo e(asset('storage/' . $member->image_path)); ?>" alt="<?php echo e($member->name); ?>">
                                        <?php else: ?>
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-sm text-gray-500"><?php echo e($member->role); ?></div>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button type="button" onclick="editTeamMember(<?php echo e($member->id); ?>)" class="text-primary-600 hover:text-primary-900">
                                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                        </svg>
                                    </button>
                                    <button type="button" onclick="confirmDelete(<?php echo e($member->id); ?>)" class="text-red-600 hover:text-red-900">
                                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\admin\content\team-members.blade.php ENDPATH**/ ?>