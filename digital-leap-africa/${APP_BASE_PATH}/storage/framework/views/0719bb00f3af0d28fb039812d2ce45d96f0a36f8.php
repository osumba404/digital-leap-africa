                ...
                <div class="project-card">
                    ...
                    <div class="project-content">
                        <h3 class="project-title">
                            <a href="<?php echo e(route('projects.show', $project)); ?>" style="color: inherit; text-decoration: none;">
                        ...
                        <div class="project-meta">
                            ...
                            <a href="<?php echo e(route('projects.show', $project)); ?>" class="btn-primary" style="padding: 0.5rem 1.25rem;">
                                View Project
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\pages\projects\index.blade.php ENDPATH**/ ?>