        ...
        <form action="<?php echo e(route('admin.about.partners.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control bg-primary-light border-0 text-gray-200" id="website_url" 
                       name="website_url" value="<?php echo e(old('website_url')); ?>" placeholder="https://example.com">
            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\admin\about\partners\create.blade.php ENDPATH**/ ?>