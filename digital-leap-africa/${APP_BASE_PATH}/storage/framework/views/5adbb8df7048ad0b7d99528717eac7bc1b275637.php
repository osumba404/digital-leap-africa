...
<?php $__env->startSection('title', 'Contact Us - Digital Leap Africa'); ?>
            ...
            <div class="contact-info-card">
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div>
                            <h3>Email</h3>
                            <p><?php echo e(\App\Helpers\SettingsHelper::get('contact_email', 'info@digitaleapafrica.com')); ?></p>
                        </div>
                    </div>
                    <div class="contact-item">
                        ...
                        <div>
                            <h3>Phone</h3>
                            <p><?php echo e(\App\Helpers\SettingsHelper::get('phone_number', '+254 700 000 000')); ?></p>
                        </div>
                    </div>
                    <div class="contact-item">
                        ...
                        <div>
                            <h3>Address</h3>
                            <p><?php echo e(\App\Helpers\SettingsHelper::get('address', 'Nairobi, Kenya')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\contact.blade.php ENDPATH**/ ?>