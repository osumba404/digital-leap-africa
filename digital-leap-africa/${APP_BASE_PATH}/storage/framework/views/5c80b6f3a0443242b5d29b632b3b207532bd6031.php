...
<div class="container">
    <div class="thread-container">
        ...
        <div class="breadcrumb">
            <a href="<?php echo e(route('forum.index')); ?>">Community Forum</a>
        ...
        <div class="thread-post">
            <div class="post-header">
                <div class="user-avatar">
                    <?php if($thread->user && $thread->user->profile_photo): ?>
                        <img src="<?php echo e(route('me.photo', ['user_id' => $thread->user->id])); ?>" alt="<?php echo e($thread->user->name); ?>">
                    <?php else: ?>
                        <?php echo e(strtoupper(substr($thread->user->name ?? 'U', 0, 1))); ?>

                    <?php endif; ?>
                </div>
                <div class="post-meta">
                    <div class="post-author"><?php echo e($thread->user->name); ?></div>
                    <div class="post-time">
                        <i class="fas fa-clock me-1"></i><?php echo e($thread->created_at->format('M j, Y \a\t g:i A')); ?>
                ...
                <div class="thread-stats">
                    <div class="stat-item">
                        ...
                        <span><?php echo e($thread->replies->count()); ?> replies</span>
                    </div>
                </div>
            </div>
            ...
            <div class="post-content">
                <?php echo nl2br(e($thread->content ?? $thread->body ?? '')); ?>
        ...
        <?php if($thread->replies->count() > 0): ?>
            <div style="margin-bottom: 2rem;">
                <h3 style="color: var(--diamond-white); font-size: 1.25rem; margin-bottom: 1.5rem;">
                    <i class="fas fa-comments me-2"></i>Replies (<?php echo e($thread->replies->count()); ?>)
                </h3>
                ...
                <?php $__currentLoopData = $thread->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="reply-post">
                        <div class="post-header">
                            <div class="user-avatar">
                                <?php if($reply->user && $reply->user->profile_photo): ?>
                                    <img src="<?php echo e(route('me.photo', ['user_id' => $reply->user->id])); ?>" alt="<?php echo e($reply->user->name); ?>">
                                <?php else: ?>
                            ...
                            <div class="post-meta">
                                <div class="post-author"><?php echo e($reply->user->name); ?></div>
                                <div class="post-time">
                                    <i class="fas fa-clock me-1"></i><?php echo e($reply->created_at->format('M j, Y \a\t g:i A')); ?>
                        ...
                        <div class="post-content">
                            <?php echo nl2br(e($reply->content ?? $reply->body ?? '')); ?>
        ...
        <?php if(auth()->guard()->check()): ?>
            <div class="reply-form">
                ...
                <form method="POST" action="<?php echo e(route('forum.reply', $thread)); ?>">
                    <?php echo csrf_field(); ?>
            ...
            <div class="reply-form">
                <div style="text-align: center;">
                    ...
                    <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn-outline" style="padding: 0.75rem 1.5rem;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\pages\forum\show.blade.php ENDPATH**/ ?>