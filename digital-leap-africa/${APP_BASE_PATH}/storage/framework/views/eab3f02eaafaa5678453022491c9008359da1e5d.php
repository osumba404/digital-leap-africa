    ...
    <div class="status-card">
        ...
        <?php elseif($payment->status === 'completed'): ?>
            ...
            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                <a href="<?php echo e(route('courses.show', $payment->course)); ?>" class="btn-primary" style="padding: 0.75rem 2rem; display: inline-flex; align-items: center; gap: 0.5rem;">
                    <i class="fas fa-play"></i>Start Learning Now
                </a>
                <a href="<?php echo e(route('dashboard')); ?>" class="btn-outline" style="padding: 0.75rem 2rem; display: inline-flex; align-items: center; gap: 0.5rem;">
        ...
        <?php elseif($payment->status === 'failed'): ?>
            ...
            <a href="<?php echo e(route('courses.show', $payment->course)); ?>" class="btn-primary" style="padding: 0.75rem 2rem;">
        ...
        <div style="margin-top: 2rem; padding-top: 2rem; border-top: 1px solid rgba(255, 255, 255, 0.1);">
            <p style="color: var(--cool-gray); font-size: 0.85rem; margin-bottom: 0.5rem;">
                <strong>Course:</strong> <?php echo e($payment->course->title); ?>

            </p>
            <p style="color: var(--cool-gray); font-size: 0.85rem; margin-bottom: 0.5rem;">
                <strong>Amount:</strong> KES <?php echo e(number_format($payment->amount, 2)); ?>

            </p>
            <p style="color: var(--cool-gray); font-size: 0.85rem; margin-bottom: 0;">
                <strong>Phone:</strong> <?php echo e($payment->phone_number); ?>
...
let pollInterval = setInterval(function() {
    fetch('<?php echo e(route('payment.poll', $payment)); ?>')
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\payments\status.blade.php ENDPATH**/ ?>