...
<?php $__env->startSection('title', 'My Testimonials'); ?>
  ...
  <div class="container">
    <div class="hero-content">
      ...
      <div class="stats-container">
        <div class="stat-card">
          <span class="stat-number"><?php echo e($testimonials->count()); ?></span>
          <span class="stat-label">Total Shared</span>
        </div>
        <div class="stat-card">
          <span class="stat-number"><?php echo e($testimonials->where('is_active', true)->count()); ?></span>
          <span class="stat-label">Published</span>
        </div>
      </div>
      
      <div class="hero-actions">
        <a href="<?php echo e(route('testimonials.create')); ?>" class="btn-hero btn-primary-hero">
          <i class="fas fa-plus"></i> Share New Testimonial
        </a>
        <a href="<?php echo e(route('testimonials.index')); ?>" class="btn-hero btn-outline-hero">
            ...
            <div class="testimonial-header">
              <div class="user-avatar">
                <?php if(!empty($testimonial->avatar_url)): ?>
                  <img src="<?php echo e($testimonial->avatar_url); ?>" alt="<?php echo e($testimonial->name ?? ($testimonial->user->name ?? 'User')); ?>">
                <?php else: ?>
                  <?php echo e(strtoupper(mb_substr($testimonial->name ?? ($testimonial->user->name ?? 'U'), 0, 1))); ?>

                <?php endif; ?>
              </div>
              <div class="user-info">
                <h3 class="user-name"><?php echo e($testimonial->name ?? ($testimonial->user->name ?? 'Anonymous Learner')); ?></h3>
                <div class="testimonial-date">
                  <i class="fas fa-calendar-alt"></i>
                  Shared <?php echo e($testimonial->created_at?->format('M d, Y')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\profile\testimonials.blade.php ENDPATH**/ ?>