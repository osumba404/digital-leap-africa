...
<div class="page-header">
    ...
    <div class="page-actions">
        <a href="<?php echo e(route('admin.jobs.create')); ?>" class="btn-primary" style="padding: 0.5rem 1rem; font-size: 0.9rem;">
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="job-description"><?php echo e(Str::limit($job->description, 50)); ?></div>
                    </div>
                </td>
                ...
                <td>
                    <?php if($job->job_type): ?>
                        <span class="status-badge status-active"><?php echo e(ucfirst($job->job_type)); ?></span>
                    <?php endif; ?>
                </td>
                <td><?php echo e($job->created_at->format('M j, Y')); ?></td>
                <td>
                    <div class="action-buttons">
                        <a href="<?php echo e(route('admin.jobs.edit', $job)); ?>" class="btn-sm btn-edit">
...
<div style="text-align: center; padding: 3rem 0;">
    ...
    <a href="<?php echo e(route('admin.jobs.create')); ?>" class="btn-primary" style="padding: 0.6rem 1.5rem; font-size: 0.95rem;">
        <i class="fas fa-plus me-2"></i>Post First Job
    </a>
</div>
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\admin\jobs\index.blade.php ENDPATH**/ ?>