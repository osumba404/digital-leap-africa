        ...
        <div class="admin-shell">
            <aside class="admin-sidebar" id="adminSidebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.about.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.about.index')); ?>">
                            <i class="fas fa-circle-info"></i><span class="sidebar-label">About</span>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.articles.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.articles.index')); ?>">
                    ...
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.projects.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.projects.index')); ?>">
                            <i class="fas fa-diagram-project"></i><span class="sidebar-label">Projects</span>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.jobs.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.jobs.index')); ?>">
                            <i class="fas fa-briefcase"></i><span class="sidebar-label">Jobs</span>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.events.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.events.index')); ?>">
                            <i class="fas fa-calendar-days"></i><span class="sidebar-label">Events</span>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.forum.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.forum.index')); ?>">
                            <i class="fas fa-comments"></i><span class="sidebar-label">Forum</span>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.testimonials.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.testimonials.index')); ?>">
                            <i class="fas fa-quote-left"></i><span class="sidebar-label">Testimonials</span>

                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.badges.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.badges.index')); ?>">
                            <i class="fas fa-medal"></i><span class="sidebar-label">Badges</span>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.users.index')); ?>">
                            <i class="fas fa-users"></i><span class="sidebar-label">Users</span>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.contact-messages.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.contact-messages.index')); ?>">
                            <i class="fas fa-envelope"></i><span class="sidebar-label">Messages</span>

                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.faqs.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.faqs.index')); ?>">
                            <i class="fas fa-circle-question"></i><span class="sidebar-label">FAQs</span>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.elibrary-resources.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.elibrary-resources.index')); ?>">
                            <i class="fas fa-book"></i><span class="sidebar-label">eLibrary</span>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.certificates.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.certificates.index')); ?>">
                            <i class="fas fa-certificate"></i><span class="sidebar-label">Certificates</span>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-link <?php echo e(request()->routeIs('admin.settings.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.settings.index')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\admin\layout.blade.php ENDPATH**/ ?>