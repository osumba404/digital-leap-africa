...
<div class="admin-card">
    <div class="admin-card-header d-flex justify-content-between align-items-center">
        <h2>Edit Article</h2>
        <a href="<?php echo e(route('admin.articles.index')); ?>" class="btn btn-outline-secondary">Back</a>
    </div>
    <form id="article-form" method="POST" action="<?php echo e(route('admin.articles.update', $article)); ?>" enctype="multipart/form-data" class="p-3">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\admin\articles\edit.blade.php ENDPATH**/ ?>