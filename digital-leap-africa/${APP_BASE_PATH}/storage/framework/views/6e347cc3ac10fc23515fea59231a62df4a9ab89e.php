    ...
    <div class="email-container">
        ...
        <div class="footer">
            <p>
                ...
                <a href="<?php echo e(config('app.url')); ?>">Visit our website</a> | 
                <a href="mailto:support@digitaleapafrica.com">Contact Support</a>
            </p>
            <p style="margin-top: 15px; font-size: 12px;">
                © <?php echo e(date('Y')); ?> Digital Leap Africa. All rights reserved.
            </p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\emails\base-notification.blade.php ENDPATH**/ ?>