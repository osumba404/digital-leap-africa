        ...
        <form method="POST" action="/reset-password">
            ...
            <div class="form-group">
                ...
                <input id="email" type="email" class="form-control" 
                       value="<?php echo e(request()->get('email')); ?>" readonly>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>