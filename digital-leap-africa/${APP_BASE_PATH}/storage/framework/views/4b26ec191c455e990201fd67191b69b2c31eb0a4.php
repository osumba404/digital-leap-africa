...
<div class="page-header">
    ...
    <div class="page-actions">
        <a href="<?php echo e(route('admin.articles.create')); ?>" class="btn-primary" style="padding: 0.5rem 1rem; font-size: 0.9rem;">
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="article-excerpt"><?php echo e(Str::limit($article->excerpt ?? $article->content, 60)); ?></div>
                    </div>
                </td>
                <td><?php echo e($article->author->name ?? 'Unknown'); ?></td>
                <td>
                ...
                <td><?php echo e($article->published_at ? $article->published_at->format('M j, Y') : '—'); ?></td>
                <td><?php echo e($article->created_at->format('M j, Y')); ?></td>
                <td>
                    <div class="action-buttons">
                        <a href="<?php echo e(route('admin.articles.edit', $article)); ?>" class="btn-sm btn-edit">
                            <i class="fas fa-edit"></i>Edit
                        </a>
                        <form method="POST" action="<?php echo e(route('admin.articles.destroy', $article)); ?>" style="display: inline;">
                            <?php echo csrf_field(); ?>
...
<div style="text-align: center; padding: 3rem 0;">
    ...
    <a href="<?php echo e(route('admin.articles.create')); ?>" class="btn-primary" style="padding: 0.6rem 1.5rem; font-size: 0.95rem;">
        <i class="fas fa-plus me-2"></i>Write First Article
    </a>
</div>
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\admin\articles\index.blade.php ENDPATH**/ ?>