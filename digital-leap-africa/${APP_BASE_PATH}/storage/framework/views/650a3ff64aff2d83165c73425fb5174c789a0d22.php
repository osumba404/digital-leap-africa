        ...
        <form action="<?php echo e(route('admin.about.team.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control bg-primary-light border-0 text-gray-200" id="role" 
                       name="role" value="<?php echo e(old('role')); ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control bg-primary-light border-0 text-gray-200" id="bio" 
                          name="bio" rows="4"><?php echo e(old('bio')); ?></textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control bg-primary-light border-0 text-gray-200" id="facebook_url" 
                       name="facebook_url" value="<?php echo e(old('facebook_url')); ?>" placeholder="https://facebook.com/username">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control bg-primary-light border-0 text-gray-200" id="instagram_url" 
                       name="instagram_url" value="<?php echo e(old('instagram_url')); ?>" placeholder="https://instagram.com/username">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control bg-primary-light border-0 text-gray-200" id="linkedin_url" 
                       name="linkedin_url" value="<?php echo e(old('linkedin_url')); ?>">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control bg-primary-light border-0 text-gray-200" id="twitter_url" 
                       name="twitter_url" value="<?php echo e(old('twitter_url')); ?>">
            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\admin\about\team\create.blade.php ENDPATH**/ ?>