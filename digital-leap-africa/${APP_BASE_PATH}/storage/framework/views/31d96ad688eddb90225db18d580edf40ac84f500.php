    ...
    <div class="certificate-container">
        <div class="certificate-inner">
            ...
            <div class="certificate-date">
                📅 <?php echo e($certificate->issued_at->format('F j, Y')); ?>

            </div>
            <div class="certificate-number">
                🛡️ <?php echo e($certificate->certificate_number); ?>

            </div>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\DLA\digital-leap-africa\digital-leap-africa\resources\views\certificates\download.blade.php ENDPATH**/ ?>